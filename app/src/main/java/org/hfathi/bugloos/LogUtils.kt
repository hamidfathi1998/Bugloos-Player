 ...
 * This also applies a special "Bugloos-Player" prefix so that messages can be filtered to just from the main codebase.
 * @return The name of the object, otherwise "Anonymous Object"
 */
private fun Any.getName(): String = "Bugloos-Player.${this::class.simpleName ?: "Anonymous Object"}"
